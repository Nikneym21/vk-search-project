...
class MainInterface:
    ...
    def init_interfaces(self):
        ...
        try:
            ...
            self.link_interface = LinkComparatorInterface(self.link_frame, self.plugin_manager)
    ...
    def create_db_placeholder(self):
        ...
        ttk.Label(placeholder_frame, text="База данных недоступна", font=("Arial", 16, "bold")).pack(pady=(50, 20))

        ttk.Label(placeholder_frame, text="Проверьте настройки и попробуйте снова", font=("Arial", 12)).pack(
            pady=(0, 30)
        )

        ttk.Button(placeholder_frame, text="Повторить инициализацию", command=self.retry_database_init).pack()
    ...
    def clear_database(self):
        ...
        result = messagebox.askyesno(
            "Подтверждение", "Вы уверены, что хотите очистить всю базу данных?\n" "Это действие нельзя отменить!"
        )
